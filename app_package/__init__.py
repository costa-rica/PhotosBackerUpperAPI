...
from pb_models import login_manager, dict_sess, \
...
def create_app(config_for_flask = config):
    ...
    # # config.DIR_DB_PHOTOS_MAIN directory:
    if not os.path.exists(config_for_flask.DIR_DB_PHOTOS_MAIN):
        os.makedirs(config_for_flask.DIR_DB_PHOTOS_MAIN)
